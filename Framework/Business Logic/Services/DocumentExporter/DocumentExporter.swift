...
protocol DocumentExporter {
    ...
    func presentExporter(from controller: UIViewController, in frame: CGRect, documentURL: URL)
    ...
    func previewDocument(from controller: UIViewController, documentURL: URL)
}

final class DocumentExporterService: NSObject, DocumentExporter {
